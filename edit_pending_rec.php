...
if(isset($_POST['update']))
{
  ...
  // update user data
  $result = mysqli_query($con, "UPDATE test SET images='$images', name='$name',middle_name='$middle_name',last_name='$last_name',
...
if(isset($_POST['submit']))
{
  ...
  $query = "INSERT INTO records_app (images, name, middle_name, last_name, suffix, sex, missing_since, city, street, classification, birthday, age, height_weight, race, text_1, text_2, text_3, text_4, text_5, text_6, text_7, gmail)
    VALUES ('$images', '$name', '$middle_name', '$last_name', '$suffix', '$sex', '$missing_since', '$city', '$street', '$classification', '$birthday', '$age', '$height_weight', '$race', '$text_1', '$text_2', '$text_3', '$text_4', '$text_5', '$text_6', '$text_7', '$gmail')";
   $id = $_GET['id'];
    $result = mysqli_query($con, $query);

    // Delete data from test table
    $deleteQuery = "DELETE FROM test WHERE id=$id"; // Replace $id with the actual ID of the record to be deleted
...
{ 
  ...
  $gmail = $user_data['gmail'];
    ...
    $query = "SELECT images FROM test WHERE id =  $id";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="pending_rec.php">Pending Records</a></li>
...
<div class="container">
  ...
  <div class="col">
    ...
    <center>
    <button class="btn btn-primary" type="submit" name="update">Update</button><br><br><br>
  </center>
