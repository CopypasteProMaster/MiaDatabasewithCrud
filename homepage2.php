<?php
include 'config.php';
$query = "SELECT name, last_name,street,city,classification,race FROM records_app WHERE id = 48";
...
$query = "SELECT images FROM records_app WHERE id = 48";
$query_run = mysqli_query($con, $query);
$data = mysqli_fetch_array($query_run);
$res = $data['images'];
$res = explode(" ", $res);
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <ul class="nav nav-pills nav-stacked">
        <li><a href="homepage.php">Missing-1</a></li>
        <li><a href="homepage1.php">Missing-2</a></li>
        <li class="active"><a href="homepage2.php">Missing-3</a></li>
      </ul>
