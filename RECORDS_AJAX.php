...
if ($result) {
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($res = mysqli_fetch_assoc($result)) {
            ...
            <td>' . $res['last_name'] . '</td>
            <td><a href="edit_approved_records.php?id='.$res['id'].'">Edit</a> | <a href="view_approved_rec.php?name_id='.$res['id'].'">View</a> | <a href="delete_approved_rec.php?id='.$res['id'].'"onClick="return confirm(\'Are you sure you want to delete?\')"">delete</a></td></td>
